...
CommManager cm(1000,50000); //create instance of commManager
...
void setup()
{
    ...
    cm.addPlot("Voltages",0,3,100, vms,3); //add a plotter (two plots in same window) called "Voltages" and link to vms array
    loop_count = 0;
}
